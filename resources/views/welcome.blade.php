...
@section('title', 'About | Kiddy School')
            ...
            <div class="container">
                <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
                    <div class="col-md-8 text-center ftco-animate">
                        <h1 class="mb-4">Kidds Are The Best  <span>Explorers In The World</span></h1>
    ...
    <section class="ftco-services ftco-no-pb">Monshe Henderson
